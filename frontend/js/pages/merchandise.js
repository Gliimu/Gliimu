...
function renderProducts(products) {
    ...
    if (!products || products.length === 0) {
        dom.productGrid.innerHTML = `
            <div class="empty-state" style="grid-column: 1 / -1; text-align: center; padding: 4rem 1rem;">
                ...
                <h3 style="font-size: 1.2rem; margin-bottom: 0.5rem;">No Products Found</h3>
    ...
    const gridClass = state.viewMode === 'grid' ? 'product-grid' : 'product-list';
    dom.productGrid.className = gridClass;
...
// ================================================================
// STICKY NAV FUNCTIONS (from course page) - FIXED
// ================================================================
...
// ================================================================
// SHARE FUNCTIONS (from course page) - FIXED
// ================================================================
...
// Add this inside your existing init() function:
document.getElementById('navToggle')?.addEventListener('click', toggleNav);

// Make sure share modal is hidden on load
...
function renderFeaturedProducts() {
    ...
    dom.featuredScroll.innerHTML = featured.map(product => `
        <div class="product-card" data-id="${product.id}" style="flex: 0 0 auto; width: 220px;">
            ${product.isNew ? '<span class="product-badge new">New</span>' : ''}
            ${product.isBestseller ? '<span class="product-badge bestseller">⭐ Bestseller</span>' : ''}
...
function renderReviews() {
    ...
    scroll.innerHTML = reviews.map(review => `
...
function updateStats() {
    ...
    dom.totalSold.textContent = '2,847';
}
